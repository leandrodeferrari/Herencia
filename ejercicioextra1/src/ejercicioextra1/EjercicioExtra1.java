...
public class EjercicioExtra1 {
    ...
    public static void main(String[] args) {
        ...
        // se guarda: el nombre, documento del cliente, la fecha de alquiler, fecha de devolución, 
        // la posición del amarre y el barco que lo ocupará.	 
        // Un Barco se caracteriza por: su matrícula, su eslora en metros y año de fabricación.
        //
        // Sin embargo, se pretende diferenciar la información de algunos tipos de barcos especiales:
        //
        // a) Número de mástiles para veleros. 
        // b) Potencia en CV para barcos a motor. 
        // c) Potencia en CV y número de camarotes para yates de lujo.
        //
        ...
        // normal y sumándole el atributo particular de cada barco. En los veleros se suma el número 
        // de mástiles, en los barcos a motor se le suma la potencia en CV y en los yates se suma 
